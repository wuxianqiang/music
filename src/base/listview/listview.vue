<template>
  <scroll class="listview" :data="data" :listenScroll="listenScroll" ref="scroll" @scroll="scroll" :probeType="probeType">
      <ul>
      ...
      <div class="list-shortcut" @touchstart="shortcutStart" @touchmove.prevent.stop="shortcutMove">
          <ul>
...
export default {
  ...
  methods: {
    ...
    shortcutStart (e) {
      ...
      this._scrillTo(currentIndex, 0)
    },
    shortcutMove (e) {
      this.touch.y2 = e.touches[0].pageY
      let index = Math.floor((this.touch.y2 - this.touch.y1) / HEIGHT) + parseInt(this.touch.index)
      this._scrillTo(index, 0)
    },
    scroll (pos) {
      this.scrollY = pos.y
    },
