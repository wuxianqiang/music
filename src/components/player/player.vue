  ...
  <div class="player" v-show="playList.length>0">
    ...
    <div class="normal-player" v-show="fullScreen">
      <div class="background">
        <img :src="currentSong.image" alt="avatar" width="100%" height="100%">
      </div>
      <div class="top">
        ...
        <div class="middle-l" ref="middleL">
          <div class="cd-wrapper" ref="cdWrapper">
            <div class="cd" :class="cdCls">
              <img :src="currentSong.image" alt="avatar" class="image">
            </div>
          </div>
        ...
        <scroll class="middle-r" ref="lyricList" :data="currentLyric && currentLyric.lines">
          <div class="lyric-wrapper">
            <div v-if="currentLyric">
              <p ref="lyricLine" :class="{current: currentLineNum===index}" class="text" :key="index" v-for="(line,index) in currentLyric.lines">
                {{line.txt}}
              </p>
            </div>
          </div>
    ...
    <div class="mini-player" v-show="!fullScreen" @click="open">
      <div class="icon">
        <img :class="cdCls" :src="currentSong.image" alt="avatar" width="40" height="40">
      </div>
      <div class="text">
